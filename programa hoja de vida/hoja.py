...
def escribir_excel(datos,camposExcel,nomArchivo,workbook):
    ...
    nomArchivo = "./HojasVida/"+nomArchivo
...
ram1 =["SDRAM","Tamaño del módulo:","Fabricante del módulo:","Número de pieza del módulo:"]
...
print("POR FAVOR ESPERA MIENTRAS SE REALIZA TODO EL PROCESO")
print("="*60)
